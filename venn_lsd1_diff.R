...
png(filename=paste(home,"intersection_genesWithPeaks_Minus5kb_Plus5kb_G_H_P_L.png",sep=""),res=1700,width=87,height=87,units ="mm")
...
cairo_ps(filename=paste(home,"intersection_genesWithPeaks_Minus5kb_Plus5kb_G_H_P_L.eps",sep=""),width=3.4252,height=3.4252,fallback_resolution = 1700)
...
png(filename=paste(home,"intersection_genesWithPeaks_Minus5kb_Plus5kb_G_H_P_L_NoLabels.png",sep=""),res=1700,width=87,height=87,units ="mm")
...
cairo_ps(filename=paste(home,"intersection_genesWithPeaks_Minus5kb_Plus5kb_G_H_P_L_NoLabels.eps",sep=""),width=3.4252,height=3.4252,fallback_resolution = 1700)
...
write.table(result3,file=paste(home,"intersection_genesWithPeaks_Minus5kb_Plus5kb_G_H_P_L",".tsv",sep=""), sep='\t',row.names=F, col.names=T, quote=F)
